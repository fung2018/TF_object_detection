...
def dict_to_tf_example(year,
  ...
  img_path = os.path.join(year, image_subdirectory, img_name+'.jpg')
...
if __name__ == '__main__':
  ...
  main(year, data_dir, annotations_dir, set, ignore_difficult_instances)
